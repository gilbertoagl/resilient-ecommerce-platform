# Resilient e-commerce data platform (Chaos and SCD Type 2)
...
The primary objective is not merely data movement, but the accurate reconstruction of business history despite data noise, leveraging an **ELT** architecture.
...
```mermaid
graph LR
    A[Chaos Monkey (Python Script)] -->|Inject JSON Events| B[(Postgres Raw)]
...
**Generate Chaos (Simulated Events):**
...
**Contact**
Gilberto - https://www.linkedin.com/in/gilberto-agramont-cloud/ Data Engineer